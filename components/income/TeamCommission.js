...
import { getTransactions } from "../../service/User";
...
const TeamCommission = () => {
  ...
  const fetchTransactions = async () => {
    setIsLoading(true);
    try {
      const transactions = await getTransactions("Team Commission", "credited");
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.heading}>Team Commission</Text>
      </View>
